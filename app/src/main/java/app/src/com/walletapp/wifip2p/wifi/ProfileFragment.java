...
public class ProfileFragment extends BaseFragment {
    ...
    String LOGOUT_SOAP_ACTION = NAMESPACE + LOGOUT_METHOD_NAME;
...
//        getActivity().getSupportFragmentManager().beginTransaction().add(R.id.container_current,new BarcodeFragment());
    ...
    private void sendReferral() {
        try {
            ...
            sAux = sAux + "https://play.google.com/store/apps/details?id=app.scr.com.walletapp \n\n";
...
//                String body = "<soapenv:Envelope xmlns:soapenv=\"http://www.w3.org/2003/05/soap-envelope\" xmlns:hs=\"http://tempuri.org/\">\n <soapenv:Body>\n <hs:" + METHOD_NAME + ">\n <hs:" + PARAMETER_FN + ">" + "Mansa Info" + "</hs:" + PARAMETER_FN + ">\n <hs:" + PARAMETER_PHONE + ">" + "98888988888" + "</hs:" + PARAMETER_PHONE + ">\n <hs:" + PARAMETER_EMAIL + ">" + "demo@demo.com" + "</hs:" + PARAMETER_EMAIL + ">\n  <hs:" + PARAMETER_PWD + ">" + "12345" + "</hs:" + PARAMETER_PWD + ">\n <hs:" + PARAMETER_DID + ">" + "android12345" + "</hs:" + PARAMETER_DID + ">\n </hs:" + METHOD_NAME + ">\n </soapenv:Body>\n</soapenv:Envelope>";
    ...
    private class LogOutAsync extends AsyncTask<String, String, String> {
...
//                String body = "<soapenv:Envelope xmlns:soapenv=\"http://www.w3.org/2003/05/soap-envelope\" xmlns:hs=\"http://tempuri.org/\">\n <soapenv:Body>\n <hs:" + METHOD_NAME + ">\n <hs:" + PARAMETER_FN + ">" + "Mansa Info" + "</hs:" + PARAMETER_FN + ">\n <hs:" + PARAMETER_PHONE + ">" + "98888988888" + "</hs:" + PARAMETER_PHONE + ">\n <hs:" + PARAMETER_EMAIL + ">" + "demo@demo.com" + "</hs:" + PARAMETER_EMAIL + ">\n  <hs:" + PARAMETER_PWD + ">" + "12345" + "</hs:" + PARAMETER_PWD + ">\n <hs:" + PARAMETER_DID + ">" + "android12345" + "</hs:" + PARAMETER_DID + ">\n </hs:" + METHOD_NAME + ">\n </soapenv:Body>\n</soapenv:Envelope>";
                ...
                String body = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" +
                        ...
                        "  <soap:Body>\n" +
                        "    <Logout xmlns=\"http://samepay.net/\">\n" +
                        "      <UserID>" + SharedPreferencesHandler.getStringValues(getActivity(), "userid") + "</UserID>\n" +
                        "      <device_id>" + SharedPreferencesHandler.getStringValues(getActivity(), "DeviceToken") + "</device_id>\n" +
                        "    </Logout>\n" +
                        "  </soap:Body>\n" +
                        "</soap:Envelope>";
                Log.i(TAG, "doInBackground: " + body);
                try {
                    ...
                    conn.setDefaultUseCaches(false);
                    conn.setRequestProperty("Content-Type", "text/xml");
                    conn.setRequestProperty("SOAPAction", LOGOUT_SOAP_ACTION);
                    //push the request to the server address
                    OutputStreamWriter wr = new OutputStreamWriter(conn.getOutputStream());
                    wr.write(body);
                    wr.flush();
        ...
        protected void onPostExecute(String result) {
            MyProgressDialog.dismiss(progressDialog);
            try {
                logoutJson = XML.toJSONObject(result);
                Log.e("XML", result);
                Log.e("JSON", logoutJson.toString());
                JSONObject job = logoutJson.getJSONObject("soap:Envelope");
                JSONObject job1 = job.getJSONObject("soap:Body");
                JSONObject job2 = job1.getJSONObject("LogoutResponse");
                String msg = job2.getString("LogoutResult");

                SharedPreferencesHandler.setStringValues(getActivity(), "phone", "");
                SharedPreferencesHandler.setStringValues(getActivity(), "user", "");
                SharedPreferencesHandler.setStringValues(getActivity(), "userid", "");
                SharedPreferencesHandler.setStringValues(getActivity(), "loginId", "");
                MyPreferences.getInstance(getActivity()).removePlaceObj(MyPreferences.Keys.DEVICEQR);
    ...
    public void logOutPopUp(final Activity context) {
